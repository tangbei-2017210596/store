...
import com.tb.store.common.AlipayConfig;
import com.tb.store.entity.AliPay;
...
public class AliPayController extends BaseController {
    ...
    @Resource
    private OrderService ordersMapper;

    @RequestMapping("pay") // &subject=xxx&traceNo=xxx&totalAmount=xxx
    public JsonResult<Void> pay(AliPay aliPay, HttpServletResponse httpResponse) throws Exception {
